...
function extendConf(conf) {
    ...
    conf.boot.push("~quasar-app-extension-wgo-vue-components/src/boot/register.js");
    // make sure boot & component files get transpiled
    conf.build.transpileDependencies.push(/quasar-app-extension-wgo-vue-components[\\/]src/);
    // make sure my-component css goes through webpack to avoid ssr issues
    // conf.css.push(
    //   "~quasar-app-extension-wgo-vue-components/src/component/MyComponent.sass"
    // );
}
