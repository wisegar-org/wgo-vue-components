...
class WGOInputDate extends vue_property_decorator_1.Vue {
    ...
    get inputMask() {
        return wgo_opengar_shared_1.MASK_GENERIC;
    }
    get qDateMask() {
        return wgo_opengar_shared_1.MASK_DD_MM_YYYY;
    }
    get getRules() {
        var _a, _b, _c, _d;
    ...
    mounted() {
        ...
        this.model = (0, wgo_opengar_shared_1.GetMaskedDate)(this.date || "", this.qDateMask);
    }
    onSelectionChange() {
        var _a;
        console.debug("WGOInputDate onSelectedDate : ", this.label, this.model);
        this.$refs.qDateProxy.hide();
        if ((0, wgo_opengar_shared_1.IsGenericMaskEmpty)(this.model))
            return;
        const numbersCount = (0, wgo_opengar_shared_1.GetNumbersFromString)(this.model);
        if (numbersCount.length < 8) {
            return false;
        }
        (_a = this.$refs.input) === null || _a === void 0 ? void 0 : _a.validate();
        const newSelectedDate = (0, wgo_opengar_shared_1.GetDate)(this.model, this.qDateMask);
    ...
    optionsFn(date) {
        ...
        if ((0, wgo_opengar_shared_2.IsNullOrUndefined)(date) ||
            (0, wgo_opengar_shared_2.IsNullOrUndefined)(this.minDate) ||
            (0, wgo_opengar_shared_2.IsNullOrUndefined)(this.maxDate))
            return true;
        const formattedDate = (0, wgo_opengar_shared_1.GetMaskedDate)(date, wgo_opengar_shared_1.MASK_YYYY_MM_DD);
        const formattedMinDate = (0, wgo_opengar_shared_1.GetMaskedDate)(this.minDate, wgo_opengar_shared_1.MASK_YYYY_MM_DD, this.qDateMask);
        const formattedMaxDate = (0, wgo_opengar_shared_1.GetMaskedDate)(this.maxDate, wgo_opengar_shared_1.MASK_YYYY_MM_DD, this.qDateMask);
        if (this.maxDate && !this.minDate)
            return (0, wgo_opengar_shared_1.IsDateBeforeOrEqual)(formattedDate, formattedMaxDate, wgo_opengar_shared_1.MASK_YYYY_MM_DD);
        if (!this.maxDate && this.minDate)
            return (0, wgo_opengar_shared_1.IsDateAfterOrEqual)(formattedDate, formattedMinDate, wgo_opengar_shared_1.MASK_YYYY_MM_DD);
        if (this.maxDate && this.minDate)
            return ((0, wgo_opengar_shared_1.IsDateAfterOrEqual)(formattedDate, formattedMinDate, wgo_opengar_shared_1.MASK_YYYY_MM_DD) &&
                (0, wgo_opengar_shared_1.IsDateBeforeOrEqual)(formattedDate, formattedMaxDate, wgo_opengar_shared_1.MASK_YYYY_MM_DD));
        return true;
    }
    onFocus() {
    ...
    campoObbligatorio(val) {
        ...
        return (!this.obbligatorio ||
            (!(0, wgo_opengar_shared_1.IsGenericMaskEmpty)(val) && !(0, wgo_opengar_shared_2.IsStringEmptyNullOrUndefined)(val)) ||
            "Obbligatorio");
    }
    dataValida(val) {
        console.debug("WGOInputDate dataValida: ", this.model);
        if ((0, wgo_opengar_shared_1.IsGenericMaskEmpty)(val))
            return true;
        return (0, wgo_opengar_shared_1.IsDateValid)(val, wgo_opengar_shared_1.MASK_DD_MM_YYYY) || this.$t("orionDate.wrongDate");
    }
    limitiDate(val) {
        console.debug("WGOInputDate limitiDate: ", val);
        if ((0, wgo_opengar_shared_2.IsNullOrUndefined)(val) ||
            (0, wgo_opengar_shared_2.IsNullOrUndefined)(this.minDate) ||
            (0, wgo_opengar_shared_2.IsNullOrUndefined)(this.maxDate))
            return true;
        if ((0, wgo_opengar_shared_1.IsGenericMaskEmpty)(val))
            return true;
        if (!(0, wgo_opengar_shared_1.IsDateValid)(val))
            return false;
        const formattedDate = (0, wgo_opengar_shared_1.GetMaskedDate)(val, wgo_opengar_shared_1.MASK_YYYY_MM_DD, this.qDateMask);
        const formattedMinDate = (0, wgo_opengar_shared_1.GetMaskedDate)(this.minDate, wgo_opengar_shared_1.MASK_YYYY_MM_DD, this.qDateMask);
        const formattedMaxDate = (0, wgo_opengar_shared_1.GetMaskedDate)(this.maxDate, wgo_opengar_shared_1.MASK_YYYY_MM_DD, this.qDateMask);
        const errorMin = (0, wgo_opengar_shared_1.IsDateBefore)(formattedDate, formattedMinDate, wgo_opengar_shared_1.MASK_YYYY_MM_DD);
        const errorMax = (0, wgo_opengar_shared_1.IsDateAfter)(formattedDate, formattedMaxDate, wgo_opengar_shared_1.MASK_YYYY_MM_DD);
        let msg = "";
